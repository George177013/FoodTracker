class DaysController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @day.update(day_params)
        format.html { redirect_to @day, notice: "Day was successfully updated.", status: :see_other }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to days_path, notice: "Day was successfully destroyed.", status: :see_other }
